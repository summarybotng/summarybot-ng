...
def create_dashboard_router(
    ...
    router.include_router(ruvector_router, tags=["RuVector"])  # ADR-057
    ...
    router.include_router(whatsapp_imports_router, tags=["WhatsApp Imports"])  # ADR-081
